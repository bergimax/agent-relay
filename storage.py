...
def claim_one(agent_id: str, worker_id: str | None) -> dict[str, Any] | None:
    with immediate_transaction() as db:
        ...
        if not IS_SQLITE:
            # SQLite serializes the whole transaction above via BEGIN IMMEDIATE.
            # PostgreSQL instead locks just this row, letting other workers'
            # claims for different tasks proceed concurrently.
